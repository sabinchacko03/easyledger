...
class DocumentController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        $request->validate([
            ...
            'cheque_details' => ['nullable', 'string'],
        ...
        $document = Document::create([
            ...
            'cheque_details' => $request->cheque_details ? json_decode($request->cheque_details, true) : null,
    ...
    public function sync(Request $request): JsonResponse
    {
        $request->validate([
            ...
            'documents.*.cheque_details' => ['nullable', 'string'],
        ...
        foreach ($request->documents as $draft) {
            ...
            $doc = Document::create([
                ...
                'cheque_details' => isset($draft['cheque_details']) ? json_decode($draft['cheque_details'], true) : null,
